    ...
    return (
        <Navbar collapseOnSelect expand="lg" fixed="top">
            <LinkContainer to="/">
                ...
                <Image src="/Logo3.png" alt="..." width="85" height="85" class="mr-3 rounded-circle img-thumbnail shadow-sm" />
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto ">
                    ...
                    <LinkContainer to="/consumer">
                        <Nav.Link className="nav-cal">DEMANDS</Nav.Link>
                    </LinkContainer>
                    ...
                    {
                        userInfo ? (
                            <NavDropdown title={userInfo ? userInfo.name : "Profile"}  id='username'>
                                {
